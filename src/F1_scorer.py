...
if __name__ == "__main__":
    ...
    mapping = {'exp-Negative': "exp", 'exp-Neutral': "exp", 'exp-negative': "exp", 'IN:exp-neutral': "exp", 'exp-neutral': "exp", 'IN:exp-Negative': "exp", 'IN:exp-negative': "exp", 'IN:exp-Neutral': "exp", 'targ': "targ", 'exp-positive': "exp", 'exp-Positive': "exp", 'IN:exp-Positive': "exp", 'IN:exp-positive': "exp", 'holder': "holder", 'IN:targ': "targ", 'IN:holder': "holder", 'IN:exp-None': "exp", 'exp-None': "exp", "exp-conflict": "exp", "IN:exp-conflict": "exp", "O": "O"}

    name_map = {"head_first": "Head-first",
    ...
    for setup in args.experiments:
        ...
        if not args.istest:
            ...
            predfile = os.path.join(args.preddir, setup, "1" ,"dev.conllu.pred")
        else:
            print("test")
            goldfile = os.path.join(args.golddir, setup, "test.conllu")
            predfile = os.path.join(args.preddir, setup, "1" ,"test.conllu.pred")
